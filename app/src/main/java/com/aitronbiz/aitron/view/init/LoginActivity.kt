package com.aitronbiz.aitron.view.init
...
import com.aitronbiz.aitron.BuildConfig
import com.aitronbiz.aitron.R
import com.aitronbiz.aitron.database.DataManager
import com.aitronbiz.aitron.databinding.ActivityLoginBinding
...
import com.aitronbiz.aitron.util.CustomUtil.networkStatus
import com.aitronbiz.aitron.view.home.MainActivity
...
//      Log.i(TAG, "${Utility.getKeyHash(this)}")
    ...
    private fun createUser(user: User) {
        ...
        if(getUserId > 0) {
            AppController.prefs.setUserPrefs("prefs", getUserId) // 사용자ID 저장
